                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="/about.php" class="text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium text-white">About</a>
                            <a href="/contact.php" class="text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium text-white">Contact</a>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
